...
class MyAppAnimationLoaderWidget extends StatelessWidget {
  /// Default constructor for the MyAppAnimationLoaderWidget.
  ///
  /// PrameterS:
          ...
          showAction
              ? SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(backgroundColor: MyAppColors.dark),
                    child: Text(
                      actionText!,
                      style: Theme.of(context).textTheme.bodyMedium!.apply(color: MyAppColors.light),
                    ),
                  ),
                )
              : const SizedBox(),
